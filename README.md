...
- 取得元: Google News（英・日）、Yahoo Finance、Nasdaq.com、各社の公式ニュース、SEC EDGAR、東証の適時開示（非公式の中継 RSS）、業界専門メディア
- 要約: 記事本文を取り出して Gemini API で日本語の要約を作成（200〜350字程度）。本文が取れない報道記事（有料記事・アクセス拒否など）は掲載しません。公式発表と SEC の書類は本文がなくても掲載します
